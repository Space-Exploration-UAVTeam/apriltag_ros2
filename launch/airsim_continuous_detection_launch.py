...
def generate_launch_description():
   ...
   return LaunchDescription([
      ...
      Node(
         ...
         parameters=[{'publish_tag_detections_image': LaunchConfiguration('publish_tag_detections_image'),}],
         remappings=[('/hikrobot/image_left', '/airsim_node/Drone51/bottom_cam/Scene')]
      ),
   ])